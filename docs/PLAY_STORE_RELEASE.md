...
1. Build and validate the app on JDK 17.
2. Produce a release build using environment-based signing variables.
3. Capture production screenshots from a physical device or stable emulator.
4. Confirm the published privacy-policy URL before Play Console submission.
...
- Confirm release-signing workflow
- Decide whether GitHub Pages will host the privacy policy
